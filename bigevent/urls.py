...
urlpatterns = [
    ...
    url(r'^admin/register/',auth_views.register,name="register"),
    url(r'^admin/checkUser/',auth_views.checkUser,name="checkUser"),
    url(r'^admin/logout/',auth_views.logout,name="logout" ),
    url(r'^admin/test/',auth_views.test,name="test"),
